  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Termine verwalten</h1>
          <p className="text-slate-400">Erstelle, bearbeite und lösche deine Events und Auftritte</p>
        </div>
        <button
          onClick={() => {
            resetForm()
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-lg hover:shadow-lg hover:shadow-teal-500/50 transition font-medium"
        >
          <Plus size={20} />
          Neues Event
        </button>
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2 pt-4">
              <button
                type="submit"
                className="flex-1 px-4 py-2 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-lg hover:shadow-lg transition font-medium"
              >
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {event.groups?.map((group) => (
              <span key={group} className="inline-block px-2 py-1 bg-purple-500/20 text-purple-300 text-xs rounded">
                {group}
              </span>
            ))}
          </div>
