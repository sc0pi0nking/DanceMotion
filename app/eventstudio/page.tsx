...
import EventRequestModal from '@/app/components/EventRequestModal';
...
export default function EventstudioPage() {
  ...
  return (
    <>
        ...
        <div className="mt-12 space-y-8">
          ...
          <section>
            ...
            <button 
              ...
              className="inline-block mt-4 px-6 py-3 rounded-full font-semibold hover:opacity-90 transition-opacity"
              style={{
      ...
      <EventRequestModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </>
  );
}
